...
ActiveRecord::Schema.define(:version => 20130520164310) do
  ...
  add_index "events", ["uri"], :name => "index_events_on_uri"
  ...
  add_index "specials", ["type"], :name => "index_specials_on_type"
  add_index "specials", ["venue_id"], :name => "index_specials_on_venue_id"
